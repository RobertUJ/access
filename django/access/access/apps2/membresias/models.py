...
class membresia(models.Model):
	...
	re_email 		 		= models.EmailField(verbose_name='Re-ingresa el Email',max_length=200,null=True,blank=True)
...
class info_adicional(models.Model):
	...
	tipo_poliza 			= models.ForeignKey(tipo_poliza, verbose_name="Seleccione el tipo de póliza")
	tipo_cobertura 			= models.ForeignKey(tipo_cobertura, verbose_name="Seleccione el tipo de cobertura")
	...
	nombre_dr_mexico	     = models.CharField(verbose_name='Nombre del su doctor en México', max_length=255,blank=True,null=True)
	telefono_dr_mexico	     = models.CharField(verbose_name='Teléfono de su doctor en México', max_length=255,blank=True,null=True)
	info_adicional_tx_center = models.TextField(verbose_name='Inf. Adicional Solicidtada por TX Medical Center',blank=True,null=True)
